...
MY_CONSUMER_KEY = environ.get('sQQNYJOSNS3y1fUtDB4lOH5Xc')#Your Twitter API Consumer Key set in Heroku config
MY_CONSUMER_SECRET = environ.get('BsFawXY9evUC89oAlfQIsQdQ4qAepluMcYnIGefWVvyvEzRkUU')#Your Consumer Secret Key set in Heroku config
MY_ACCESS_TOKEN_KEY = environ.get('1160024199118954496-TO0mrtMKIYLwjk3UqflKlqLYlOzRp8')#Your Twitter API Access Token Key set in Heroku config
MY_ACCESS_TOKEN_SECRET = environ.get('NnPSYCH99Ev2gbquoPKeOFcNVkwBuHgaaWa71POmY6J08')#Your Access Token Secret set in Heroku config
...
TWITTER_SOURCE_ACCOUNTS = ["444kiki_fae_b0t"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "ghostxpancake" # The name of the account you're tweeting to.
